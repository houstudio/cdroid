...
def main():
    ...
    ds_attrs = parse_attrs_xml(args.attrs)
    ...
    L.append(f'// Source: {os.path.basename(args.attrs)}  (fw-ids: {os.path.basename(args.fw_ids)})')
