...
static const svg_color_map_t SVG_COLOR_MAP[] = {
    ...
    { "darkgoldenrod",        { 0, PACK_RGB (184,134, 11) }},
    { "darkgray",             { 0, PACK_RGB (169,169,169) }},
    ...
    { "floralwhite",          { 0, PACK_RGB (255,250,240) }},
    ...
    { "midnightblue",         { 0, PACK_RGB ( 25, 25,112) }},
    { "mintcream",            { 0, PACK_RGB (245,255,250) }},
    { "mistyrose",            { 0, PACK_RGB (255,228,225) }},
    ...
    { "slategrey",            { 0, PACK_RGB (112,128,144) }},
    { "snow",                 { 0, PACK_RGB (255,250,250) }},
...
_svg_color_init_from_str (svg_color_t *color, const char *str)
{
    ...
    map = bsearch (str, SVG_COLOR_MAP, SVG_ARRAY_SIZE (SVG_COLOR_MAP), sizeof (svg_color_map_t),
                   _svg_color_cmp);

    /* XXX: default to black until animate fill (freeze/remove) and system colors are handled */
    if (map == NULL)
