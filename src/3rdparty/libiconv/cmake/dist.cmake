...
if ( NOT EXISTS ${PROJECT_SOURCE_DIR}/dist.info )
  message ( FATAL_ERROR
    "Missing dist.info file (${PROJECT_SOURCE_DIR}/dist.info)." )
endif ()
file ( READ ${PROJECT_SOURCE_DIR}/dist.info DIST_INFO )
...
macro ( install_header )
  ...
  foreach ( _file ${_ARG_DEFAULT_ARGS} )
    if ( IS_DIRECTORY "${PROJECT_SOURCE_DIR}/${_file}" )
