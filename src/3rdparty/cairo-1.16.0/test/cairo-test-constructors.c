...
extern void _register_bug_75705 (void);
...
extern void _register_create_from_broken_png_stream (void);
...
extern void _register_record_neg_extents_unbounded (void);
extern void _register_record_neg_extents_bounded (void);
extern void _register_record_mesh (void);
extern void _register_record_replay_extend_none (void);
extern void _register_record_replay_extend_repeat (void);
extern void _register_record_replay_extend_reflect (void);
extern void _register_record_replay_extend_pad (void);
extern void _register_recording_ink_extents (void);
...
extern void _register_smp_glyph (void);
...
extern void _register_text_subpixel_positioning (void);
extern void _register_text_transform (void);
extern void _register_text_unhinted_metrics (void);
...
extern void _register_font_variations (void);
...
_cairo_test_runner_register_tests (void)
{
    ...
    _register_create_from_broken_png_stream ();
    ...
    _register_record_neg_extents_unbounded ();
    _register_record_neg_extents_bounded ();
    _register_record_mesh ();
    _register_record_replay_extend_none ();
    _register_record_replay_extend_repeat ();
    _register_record_replay_extend_reflect ();
    _register_record_replay_extend_pad ();
    _register_recording_ink_extents ();
    ...
    _register_text_subpixel_positioning ();
    _register_text_transform ();
    _register_text_unhinted_metrics ();
