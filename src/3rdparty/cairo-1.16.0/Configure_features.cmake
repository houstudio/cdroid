...
if(FONTCONFIG_FOUND AND MINIMAL_SIZE_OPTIMIZED)
    set(CAIRO_HAS_FT_FONT 0) #added for size optimized
endif()
...
if (MINIMAL_SIZE_OPTIMIZED )
    set(CAIRO_HAS_SVG_SURFACE 0)
    set(CAIRO_HAS_SCRIPT_SURFACE 0)
    set(CAIRO_HAS_INTERPRETER 0)
...
configure_file(features.h.cmake ${PROJECT_BINARY_DIR}/cairo-features.h)
