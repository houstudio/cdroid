...
#ifndef CAIRO_CDROID_H
#define CAIRO_CDROID_H
...
cairo_public cairo_surface_t *cairo_cdroid_surface_create (HANDLE surface);
/*get nglsurface handle by cairo surface*/
cairo_public HANDLE cairo_cdroid_surface_get_surface (cairo_surface_t *surface);

CAIRO_END_DECLS

#else  /*CAIRO_HAS_CDROID_SURFACE*/
# error Cairo was not compiled with support for the directfb backend
#endif /*CAIRO_HAS_CDROID_SURFACE*/

#endif /*CAIRO_CDROID_H*/
