...
static void SendKeyEvent(SDL_Event*event) {
    ...
    struct {int sdlk;int key}KEYS[]={
        ...
        {SDL_SCANCODE_INSERT,124},{SDL_SCANCODE_DELETE,112/*KEYCODE_FORWARD_DEL: PC Delete = forward del, right*/},{SDL_SCANCODE_KP_ENTER,23/*DPAD_CENTER*/},{SDL_SCANCODE_ESCAPE,111},
        {SDL_SCANCODE_RETURN,66},{SDL_SCANCODE_SPACE,62},{SDL_SCANCODE_BACKSPACE,67/*KEYCODE_DEL: PC BackSpace = backspace, left*/},{SDL_SCANCODE_MENU,82},
