...
static const uint32_t arrow_cursor_24x24_data[24 * 24] = {
...
static struct{int xkey;int key;}X11KEY2CD[]={
   ...
   {XK_Left,21},{XK_Right,22},{XK_Up,19},{XK_Down,20},
   {XK_KP_Left,21},{XK_KP_Right,22},{XK_KP_Up,19},{XK_KP_Down,20},{XK_Home,122},{XK_End,123},{XK_Page_Up,92},{XK_Page_Down,93},
   {XK_Insert,124},{XK_Delete,112/*KEYCODE_FORWARD_DEL: PC Delete = forward del, right*/},{XK_KP_Enter,23/*DPAD_CENTER*/},{XK_Escape,111},
   {XK_Return,66},{XK_KP_Space,62},{XK_BackSpace,67/*KEYCODE_DEL: PC BackSpace = backspace, left*/},{XK_Menu,82},
