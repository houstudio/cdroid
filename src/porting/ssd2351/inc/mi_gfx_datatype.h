...
typedef enum
{
    ...
    E_MI_GFX_ERR_GFX_DRV_FAIL_INIT,
    E_MI_GFX_ERR_GFX_DRV_FAIL_SET_PARAM,
    E_MI_GFX_ERR_GFX_DRV_FAIL_GET_PARAM,
    E_MI_GFX_ERR_MAX
} MI_GFX_ErrCode_e;
...
#define MI_ERR_GFX_DRV_FAIL_INIT MI_DEF_ERR(E_MI_MODULE_ID_GFX, E_MI_ERR_LEVEL_ERROR, E_MI_GFX_ERR_GFX_DRV_FAIL_INIT)
#define MI_ERR_GFX_DRV_FAIL_SET_PARAM MI_DEF_ERR(E_MI_MODULE_ID_GFX, E_MI_ERR_LEVEL_ERROR, E_MI_GFX_ERR_GFX_DRV_FAIL_SET_PARAM)
#define MI_ERR_GFX_DRV_FAIL_GET_PARAM MI_DEF_ERR(E_MI_MODULE_ID_GFX, E_MI_ERR_LEVEL_ERROR, E_MI_GFX_ERR_GFX_DRV_FAIL_GET_PARAM)
