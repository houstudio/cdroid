...
{
    HI_BOOL             bConnected;             /**<The Device is connected or disconnected  */
    HI_BOOL             bSinkPowerOn;           /**<The sink is PowerOn or not */
    HI_BOOL             bAuthed;                /**<HDCP Authentication  */
    HI_U8               u8Bksv[5];              /**<Bksv of sink 40bits*/
}HI_HDMI_STATUS_S;
...
typedef struct hiHDMI_ATTR_S
{
    ...
    HI_HDMI_QUANTIZATION_E  eOutCscQuantization; /**< CSC output quantization range HDMI_QUANTIZATION_RANGE_LIMITED, HDMI_QUANTIZATION_RANGE_FULL>**/
...
typedef struct hiHI_HDMI_CSC_S
{
    ...
    HI_U32 u32Saturation;               /* satuature:   0 ~ 100 default: 50 */
} HI_HDMI_CSC_S;
...
typedef union hiUNF_CEC_OPERAND_U
{
