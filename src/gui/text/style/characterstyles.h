...
public:
    explicit StyleSpan(int style) : StyleSpan(style, 0) {}
    StyleSpan(int style, int fontWeightAdjustment)
            : mStyle(style), mFontWeightAdjustment(fontWeightAdjustment) {}

    int getStyle() const { return mStyle; }
    int getFontWeightAdjustment() const { return mFontWeightAdjustment; }
