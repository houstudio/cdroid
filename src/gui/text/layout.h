...
public:
    ...
    enum BreakStrategy{
        BREAK_STRATEGY_SIMPLE = LineBreaker::BREAK_STRATEGY_SIMPLE,
        BREAK_STRATEGY_HIGH_QUALITY = LineBreaker::BREAK_STRATEGY_HIGH_QUALITY,
        BREAK_STRATEGY_BALANCED = LineBreaker::BREAK_STRATEGY_BALANCED
    };
    enum HyphenationFrequency{
        HYPHENATION_FREQUENCY_NONE = LineBreaker::HYPHENATION_FREQUENCY_NONE,
        HYPHENATION_FREQUENCY_NORMAL = LineBreaker::HYPHENATION_FREQUENCY_NORMAL,
        HYPHENATION_FREQUENCY_FULL = LineBreaker::HYPHENATION_FREQUENCY_FULL,
        HYPHENATION_FREQUENCY_NORMAL_FAST = LineBreaker::HYPHENATION_FREQUENCY_NORMAL_FAST,
        HYPHENATION_FREQUENCY_FULL_FAST = LineBreaker::HYPHENATION_FREQUENCY_FULL_FAST
    };
    enum JustificationMode{
        JUSTIFICATION_MODE_NONE = LineBreaker::JUSTIFICATION_MODE_NONE,
        JUSTIFICATION_MODE_INTER_WORD = LineBreaker::JUSTIFICATION_MODE_INTER_WORD,
        JUSTIFICATION_MODE_INTER_CHARACTER=LineBreaker::JUSTIFICATION_MODE_INTER_CHARACTER
    };
