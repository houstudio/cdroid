...
private:
    ...
    void inflateChildElements(Resources& r,XmlPullParser&,const AttributeSet&);
...
public:
    ...
    void setStroke(int width, const cdroid::RefPtr<ColorStateList>& colorStateList);
    void setStroke(int width,int color, float dashWidth, float dashGap);
    void setStroke(int width, const cdroid::RefPtr<ColorStateList>& colorStateList, float dashWidth, float dashGap);
    ...
    void setColor(const cdroid::RefPtr<ColorStateList>& colorStateList);
