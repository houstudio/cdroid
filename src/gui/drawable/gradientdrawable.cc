...
void GradientDrawable::inflate(Resources& r,XmlPullParser&parser,const AttributeSet&atts){
    ...
    auto ta = r.obtainStyledAttributes(atts, internal::R::styleable::GradientDrawable);
...
void GradientDrawable::updateStateFromTypedArray(const TypedArray& a) {
    ...
    state->mShape = a.getInt(internal::R::styleable::GradientDrawable_shape, state->mShape);

    state->mDither = a.getBoolean(internal::R::styleable::GradientDrawable_dither, state->mDither);

    if (state->mShape == GradientDrawable::RING) {
        state->mInnerRadius = a.getDimensionPixelSize(internal::R::styleable::GradientDrawable_innerRadius, state->mInnerRadius);
        if (state->mInnerRadius == -1) {
            state->mInnerRadiusRatio = a.getFloat(internal::R::styleable::GradientDrawable_innerRadiusRatio, state->mInnerRadiusRatio);
        }

        state->mThickness = a.getDimensionPixelSize(internal::R::styleable::GradientDrawable_thickness, state->mThickness);
        if (state->mThickness == -1) {
            state->mThicknessRatio = a.getFloat(internal::R::styleable::GradientDrawable_thicknessRatio, state->mThicknessRatio);
        }

        state->mUseLevelForShape = a.getBoolean(internal::R::styleable::GradientDrawable_useLevel, state->mUseLevelForShape);
    }

    // aapt2 pre-resolves the tintMode enum; -1 means "not specified".
    const int tintMode = a.getInt(internal::R::styleable::GradientDrawable_tintMode, -1);
    if (tintMode != -1) {
        state->mTintMode = tintMode;
    }

    auto tint = a.getColorStateList(internal::R::styleable::GradientDrawable_tint);
    if (tint != nullptr) {
        state->mTint = tint;
    }

    const int insetLeft = a.getDimensionPixelSize(internal::R::styleable::GradientDrawable_opticalInsetLeft, state->mOpticalInsets.left);
    const int insetTop = a.getDimensionPixelSize(internal::R::styleable::GradientDrawable_opticalInsetTop, state->mOpticalInsets.top);
    const int insetRight = a.getDimensionPixelSize(internal::R::styleable::GradientDrawable_opticalInsetRight, state->mOpticalInsets.right);
    const int insetBottom = a.getDimensionPixelSize(internal::R::styleable::GradientDrawable_opticalInsetBottom, state->mOpticalInsets.bottom);
...
void GradientDrawable::inflateChildElements(Resources& r,XmlPullParser&parser,const AttributeSet&atts){
    ...
    while (((type=parser.next()) != XmlPullParser::END_DOCUMENT)
        ...
        if (name.compare("size")==0) {
            auto ta = r.obtainStyledAttributes(&atts, internal::R::styleable::GradientDrawableSize);
            if (ta) updateGradientDrawableSize(*ta);
        } else if (name.compare("gradient")==0) {
            auto ta = r.obtainStyledAttributes(&atts, internal::R::styleable::GradientDrawableGradient);
            ...
            auto ta = r.obtainStyledAttributes(&atts, internal::R::styleable::GradientDrawableSolid);
            if (ta) updateGradientDrawableSolid(*ta);
        } else if (name.compare("stroke")==0) {
            auto ta = r.obtainStyledAttributes(&atts, internal::R::styleable::GradientDrawableStroke);
            if (ta) updateGradientDrawableStroke(*ta);
        } else if (name.compare("corners")==0) {
            auto ta = r.obtainStyledAttributes(&atts, internal::R::styleable::DrawableCorners);
            if (ta) updateDrawableCorners(*ta);
        } else if (name.compare("padding")==0) {
            auto ta = r.obtainStyledAttributes(&atts, internal::R::styleable::GradientDrawablePadding);
...
void GradientDrawable::updateGradientDrawableSize(const TypedArray& a){
    auto st = mGradientState;
    st->mWidth = a.getDimensionPixelSize(internal::R::styleable::GradientDrawableSize_width, st->mWidth);
    st->mHeight = a.getDimensionPixelSize(internal::R::styleable::GradientDrawableSize_height, st->mHeight);
}
...
void GradientDrawable::updateGradientDrawableGradient(const TypedArray& a){
    ...
    st->mCenterX = getFloatOrFraction(a, internal::R::styleable::GradientDrawableGradient_centerX, st->mCenterX);
    st->mCenterY = getFloatOrFraction(a, internal::R::styleable::GradientDrawableGradient_centerY, st->mCenterY);
    st->mUseLevel = a.getBoolean(internal::R::styleable::GradientDrawable_useLevel, st->mUseLevel);
    ...
    st->mGradient = a.getInt(internal::R::styleable::GradientDrawableGradient_type, st->mGradient);

    // TODO: Update these to be themeable.
    const int startColor = a.getColor(internal::R::styleable::GradientDrawableGradient_startColor, 0);
    const bool hasCenterColor = a.hasValue(internal::R::styleable::GradientDrawableGradient_centerColor);
    const bool hasStartColor = a.hasValue(internal::R::styleable::GradientDrawableGradient_startColor);
    const bool hasEndColor = a.hasValue(internal::R::styleable::GradientDrawableGradient_endColor);
    const int centerColor = a.getColor(internal::R::styleable::GradientDrawableGradient_centerColor, 0);
    const int endColor = a.getColor(internal::R::styleable::GradientDrawableGradient_endColor, 0);
    ...
    const int angle = ((int) a.getFloat(internal::R::styleable::GradientDrawableGradient_angle, st->mAngle))%360;
    ...
    Res_value tv;
    if (a.peekValue(internal::R::styleable::GradientDrawableGradient_gradientRadius, &tv)) {
        float radius;
        int radiusType;
        if (tv.dataType == Res_value::TYPE_FRACTION) {
            radius = a.getFraction(internal::R::styleable::GradientDrawableGradient_gradientRadius, 1, 1, 1.0f);
            ...
            radius = a.getDimension(internal::R::styleable::GradientDrawableGradient_gradientRadius, 0);
            radiusType = RADIUS_TYPE_PIXELS;
        } else {
            radius = a.getFloat(internal::R::styleable::GradientDrawableGradient_gradientRadius, 0);
            radiusType = RADIUS_TYPE_PIXELS;
        }
...
void GradientDrawable::updateGradientDrawableSolid(const TypedArray& a){
    auto colorStateList = a.getColorStateList(internal::R::styleable::GradientDrawableSolid_color);
    if(colorStateList) {
...
void GradientDrawable::updateGradientDrawableStroke(const TypedArray& a){
    ...
    const int width = a.getDimensionPixelSize(internal::R::styleable::GradientDrawableStroke_width, defaultStrokeWidth);
    const float dashWidth = a.getDimension(internal::R::styleable::GradientDrawableStroke_dashWidth, st->mStrokeDashWidth);
    const float dashGap = a.getDimension(internal::R::styleable::GradientDrawableStroke_dashGap, st->mStrokeDashGap);

    auto colorStateList = a.getColorStateList(internal::R::styleable::GradientDrawableStroke_color);
    if(colorStateList==nullptr){
...
void GradientDrawable::updateDrawableCorners(const TypedArray& a){
    ...
    // TODO: Update these to be themeable.
    const float topLeftRadius = a.getDimensionPixelSize(internal::R::styleable::DrawableCorners_topLeftRadius, radius);
    const float topRightRadius = a.getDimensionPixelSize(internal::R::styleable::DrawableCorners_topRightRadius, radius);
    const float bottomLeftRadius = a.getDimensionPixelSize(internal::R::styleable::DrawableCorners_bottomLeftRadius, radius);
    const float bottomRightRadius = a.getDimensionPixelSize(internal::R::styleable::DrawableCorners_bottomRightRadius, radius);
...
void GradientDrawable::updateGradientDrawablePadding(const TypedArray& a){
    ...
    pad.set(a.getDimensionPixelOffset(internal::R::styleable::GradientDrawablePadding_left, pad.left),
            a.getDimensionPixelOffset(internal::R::styleable::GradientDrawablePadding_top, pad.top),
            a.getDimensionPixelOffset(internal::R::styleable::GradientDrawablePadding_right, pad.width),
            a.getDimensionPixelOffset(internal::R::styleable::GradientDrawablePadding_bottom, pad.height));
