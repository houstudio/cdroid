...
protected:
    ...
    PorterDuffColorFilter *updateTintFilter(PorterDuffColorFilter* tintFilter,const RefPtr<ColorStateList>& tint,int tintMode);
...
public:
     ...
     * */
    virtual void setTintList(const RefPtr<ColorStateList>& tint);
