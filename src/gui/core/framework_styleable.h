...
namespace styleable {
    namespace View {
        enum { id, tag, scrollX, scrollY, background, padding, paddingHorizontal, paddingVertical, paddingLeft, paddingTop, paddingRight, paddingBottom, paddingStart, paddingEnd, focusable, autofillHints, importantForAutofill, importantForContentCapture, isCredential, focusableInTouchMode, visibility, fitsSystemWindows, scrollbars, scrollbarStyle, isScrollContainer, fadeScrollbars, scrollbarFadeDuration, scrollbarDefaultDelayBeforeFade, scrollbarSize, scrollbarThumbHorizontal, scrollbarThumbVertical, scrollbarTrackHorizontal, scrollbarTrackVertical, scrollbarAlwaysDrawHorizontalTrack, scrollbarAlwaysDrawVerticalTrack, fadingEdge, requiresFadingEdge, fadingEdgeLength, nextFocusLeft, nextFocusRight, nextFocusUp, nextFocusDown, nextFocusForward, clickable, longClickable, contextClickable, saveEnabled, filterTouchesWhenObscured, drawingCacheQuality, keepScreenOn, duplicateParentState, minHeight, minWidth, soundEffectsEnabled, hapticFeedbackEnabled, contentDescription, supplementalDescription, accessibilityTraversalBefore, accessibilityTraversalAfter, onClick, overScrollMode, alpha, elevation, translationX, translationY, translationZ, transformPivotX, transformPivotY, rotation, rotationX, rotationY, scaleX, scaleY, verticalScrollbarPosition, layerType, layoutDirection, textDirection, textAlignment, importantForAccessibility, accessibilityDataSensitive, accessibilityLiveRegion, labelFor, theme, transitionName, nestedScrollingEnabled, stateListAnimator, backgroundTint, backgroundTintMode, outlineProvider, foreground, foregroundGravity, foregroundTint, foregroundTintMode, scrollIndicators, pointerIcon, forceHasOverlappingRendering, tooltipText, keyboardNavigationCluster, nextClusterForward, focusedByDefault, defaultFocusHighlightEnabled, screenReaderFocusable, accessibilityPaneTitle, accessibilityHeading, allowClickWhenDisabled, outlineSpotShadowColor, outlineAmbientShadowColor, forceDarkAllowed, clipToOutline, preferKeepClear, autoHandwritingEnabled, handwritingBoundsOffsetLeft, handwritingBoundsOffsetTop, handwritingBoundsOffsetRight, handwritingBoundsOffsetBottom, contentSensitivity, COUNT };
        extern const uint32_t IDS[];
    }
    namespace ViewGroup {
        enum { animateLayoutChanges, clipChildren, clipToPadding, layoutAnimation, animationCache, persistentDrawingCache, alwaysDrawnWithCache, addStatesFromChildren, descendantFocusability, touchscreenBlocksFocus, splitMotionEvents, layoutMode, transitionGroup, COUNT };
        extern const uint32_t IDS[];
    }
    namespace LinearLayout {
        enum { orientation, gravity, baselineAligned, baselineAlignedChildIndex, weightSum, measureWithLargestChild, divider, showDividers, dividerPadding, COUNT };
        extern const uint32_t IDS[];
    }
    namespace ImageView {
        enum { src, scaleType, adjustViewBounds, maxWidth, maxHeight, tint, baselineAlignBottom, cropToPadding, baseline, tintMode, COUNT };
        extern const uint32_t IDS[];
    }
    namespace CompoundButton {
        enum { checked, button, buttonTint, buttonTintMode, COUNT };
        extern const uint32_t IDS[];
    }
    namespace FrameLayout {
        enum { measureAllChildren, COUNT };
        extern const uint32_t IDS[];
    }
    namespace TextView {
        enum { bufferType, text, hint, textColor, textColorHighlight, searchResultHighlightColor, focusedSearchResultHighlightColor, textColorHint, textAppearance, textSize, textScaleX, typeface, textStyle, textFontWeight, fontFamily, textLocale, textColorLink, cursorVisible, maxLines, maxHeight, lines, height, minLines, minHeight, maxEms, maxWidth, ems, width, minEms, minWidth, gravity, scrollHorizontally, password, singleLine, enabled, selectAllOnFocus, includeFontPadding, maxLength, shadowColor, shadowDx, shadowDy, shadowRadius, autoLink, linksClickable, numeric, digits, phoneNumber, inputMethod, capitalize, autoText, editable, freezesText, ellipsize, drawableTop, drawableBottom, drawableLeft, drawableRight, drawableStart, drawableEnd, drawablePadding, drawableTint, drawableTintMode, lineSpacingExtra, lineSpacingMultiplier, lineHeight, firstBaselineToTopHeight, lastBaselineToBottomHeight, marqueeRepeatLimit, inputType, allowUndo, imeOptions, privateImeOptions, imeActionLabel, imeActionId, editorExtras, textSelectHandleLeft, textSelectHandleRight, textSelectHandle, textEditPasteWindowLayout, textEditNoPasteWindowLayout, textEditSidePasteWindowLayout, textEditSideNoPasteWindowLayout, textEditSuggestionItemLayout, textEditSuggestionContainerLayout, textEditSuggestionHighlightStyle, textCursorDrawable, textIsSelectable, textAllCaps, elegantTextHeight, fallbackLineSpacing, letterSpacing, fontFeatureSettings, fontVariationSettings, breakStrategy, hyphenationFrequency, lineBreakStyle, lineBreakWordStyle, autoSizeTextType, autoSizeStepGranularity, autoSizePresetSizes, autoSizeMinTextSize, autoSizeMaxTextSize, justificationMode, useBoundsForWidth, shiftDrawingOffsetForStartOverhang, useLocalePreferredLineHeightForMinimum, COUNT };
        extern const uint32_t IDS[];
    }
    namespace ProgressBar {
        enum { min, max, progress, secondaryProgress, indeterminate, indeterminateOnly, indeterminateDrawable, progressDrawable, indeterminateDuration, indeterminateBehavior, minWidth, maxWidth, minHeight, maxHeight, interpolator, animationResolution, mirrorForRtl, progressTint, progressTintMode, progressBackgroundTint, progressBackgroundTintMode, secondaryProgressTint, secondaryProgressTintMode, indeterminateTint, indeterminateTintMode, backgroundTint, backgroundTintMode, COUNT };
        extern const uint32_t IDS[];
    }
    namespace Switch {
        enum { thumb, thumbTint, thumbTintMode, track, trackTint, trackTintMode, textOn, textOff, thumbTextPadding, switchTextAppearance, switchMinWidth, switchPadding, splitTrack, showText, COUNT };
        extern const uint32_t IDS[];
    }
    namespace SeekBar {
        enum { thumb, thumbOffset, splitTrack, thumbTint, thumbTintMode, tickMark, tickMarkTint, tickMarkTintMode, COUNT };
        extern const uint32_t IDS[];
    }
    namespace ToggleButton {
    ...
    namespace ListView {
        enum { entries, divider, dividerHeight, headerDividersEnabled, footerDividersEnabled, overScrollHeader, overScrollFooter, COUNT };
        extern const uint32_t IDS[];
    }
    namespace RadioGroup {
    ...
    namespace AdapterViewAnimator {
        enum { inAnimation, outAnimation, loopViews, animateFirstView, COUNT };
        extern const uint32_t IDS[];
    }
    namespace AdapterViewFlipper {
    ...
    namespace AnalogClock {
        enum { dial, hand_hour, hand_minute, hand_second, timeZone, dialTint, dialTintMode, hand_hourTint, hand_hourTintMode, hand_minuteTint, hand_minuteTintMode, hand_secondTint, hand_secondTintMode, COUNT };
        extern const uint32_t IDS[];
    }
    namespace GridView {
        enum { horizontalSpacing, verticalSpacing, stretchMode, columnWidth, numColumns, gravity, COUNT };
        extern const uint32_t IDS[];
    }
    namespace GridLayout {
        enum { orientation, rowCount, columnCount, useDefaultMargins, alignmentMode, rowOrderPreserved, columnOrderPreserved, COUNT };
        extern const uint32_t IDS[];
    }
    namespace Spinner {
        enum { prompt, spinnerMode, dropDownSelector, popupTheme, popupBackground, popupElevation, dropDownWidth, gravity, COUNT };
        extern const uint32_t IDS[];
    }
    namespace RatingBar {
    ...
    namespace RelativeLayout {
        enum { gravity, ignoreGravity, COUNT };
        extern const uint32_t IDS[];
    }
    namespace Layout {
    ...
    namespace MarginLayout {
        enum { layout_width, layout_height, layout_margin, layout_marginLeft, layout_marginTop, layout_marginRight, layout_marginBottom, layout_marginStart, layout_marginEnd, layout_marginHorizontal, layout_marginVertical, COUNT };
        extern const uint32_t IDS[];
    }
    namespace LinearLayoutLayout {
        enum { layout_width, layout_height, layout_weight, layout_gravity, COUNT };
        extern const uint32_t IDS[];
    }
    namespace GridLayoutLayout {
        enum { layout_row, layout_rowSpan, layout_rowWeight, layout_column, layout_columnSpan, layout_columnWeight, layout_gravity, COUNT };
        extern const uint32_t IDS[];
    }
    namespace TableRowLayout {
    ...
    namespace RelativeLayoutLayout {
        enum { layout_toLeftOf, layout_toRightOf, layout_above, layout_below, layout_alignBaseline, layout_alignLeft, layout_alignTop, layout_alignRight, layout_alignBottom, layout_alignParentLeft, layout_alignParentTop, layout_alignParentRight, layout_alignParentBottom, layout_centerInParent, layout_centerHorizontal, layout_centerVertical, layout_alignWithParentIfMissing, layout_toStartOf, layout_toEndOf, layout_alignStart, layout_alignEnd, layout_alignParentStart, layout_alignParentEnd, COUNT };
        extern const uint32_t IDS[];
    }
} // namespace styleable
} // namespace cdroid
