 ...
 *********************************************************************************/
#ifndef __BUDDHIST_CALENDAR_H__
#define __BUDDHIST_CALENDAR_H__
...
public:
    ...
    BuddhistCalendar(int year, int month, int date, int hourOfDay, int minute, int second);
