 ...
 *********************************************************************************/
#ifndef __JAPANESE_CALENDAR_H__
#define __JAPANESE_CALENDAR_H__
...
public:
    ...
    JapaneseCalendar(int year, int month, int date, int hourOfDay, int minute, int second);
