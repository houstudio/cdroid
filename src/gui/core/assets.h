...
public:
    ...
    Cairo::RefPtr<Cairo::ImageSurface> loadImage(const std::string&,int,int)override;
    ...
    int getColor(const std::string&resid,int def)override;
    int getDimension(const std::string&resid,int def)override;
