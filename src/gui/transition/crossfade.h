...
public:
    ...
    int getFadeBehavior() const{ return mFadeBehavior; }
    Crossfade& setResizeBehavior(int resizeBehavior);
    int getResizeBehavior() const{ return mResizeBehavior; }
    ...
    Crossfade* clone() const override{ Crossfade* c = new Crossfade(*this); copyCloneFields(c); return c; }
