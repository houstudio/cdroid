public class MenuBuilder implements Menu {
     ...
     */
    private bool mGroupDividerEnabled = false;
    ...
    private bool dispatchSubMenuSelected(SubMenuBuilder subMenu,
    ...
    void findItemsWithShortcutForKey(List<MenuItemImpl> items, int keyCode, KeyEvent event) {
        final bool qwerty = isQwertyMode();
        final int modifierState = event.getModifiers();
        final KeyCharacterMap.KeyData possibleChars = new KeyCharacterMap.KeyData();
        // Get the chars associated with the keyCode (i.e using any chording combo)
        final bool isKeyCodeMapped = event.getKeyData(possibleChars);
        ...
        for (int i = 0; i < N; i++) {
            ...
            final bool isModifiersExactMatch = (modifierState & SUPPORTED_MODIFIERS_MASK)
    ...
    public bool performItemAction(MenuItem item, MenuPresenter preferredPresenter, int flags) {
        ...
        final bool providerHasSubMenu = provider != null && provider.hasSubMenu();
