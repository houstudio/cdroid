...
class ActionMenuView :public LinearLayout,MenuView{//MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final bool isGeneratedItem = child instanceof ActionMenuItemView;
            visibleItemCount++;
        ...
        final bool centerSingleExpandedItem = hasOverflow && visibleItemCount == 2;
        ...
        final bool singleItem = !hasOverflow && visibleItemCount == 1;
    ...
    static int measureChildForCells(View child, int cellSize, int cellsRemaining,
        ...
        final bool hasText = itemView != null && itemView.hasText();
        ...
        final bool expandable = !lp.isOverflowButton && hasText;
    ...
    protected void onLayout(bool changed, int left, int top, int right, int bottom) {
        ...
        bool hasOverflow = false;
        final bool isLayoutRtl = isLayoutRtl();
        for (int i = 0; i < childCount; i++) {
    ...
    public void setOverflowReserved(bool reserveOverflow) {
    ...
    public void setExpandedActionViewsExclusive(bool exclusive) {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        /** @hide */
        public LayoutParams(int width, int height, bool isOverflowButton) {
            super(width, height);
