...
CustomVariable CustomVariable::copy() const { return CustomVariable(*this); }
...
bool CustomVariable::isContinuous() const {
    switch (mType) {
        ...
        case TypedValues::Custom::TYPE_STRING: return false;
        default: return true;
    }
}

void CustomVariable::setFloatValue(float value) { mFloatValue = value; }
void CustomVariable::setBooleanValue(bool value) { mBooleanValue = value; }
void CustomVariable::setIntValue(int value) { mIntegerValue = value; }
void CustomVariable::setStringValue(const std::string& value) { mStringValue = value; }
...
float CustomVariable::getValueToInterpolate() const {
    switch (mType) {
        case TypedValues::Custom::TYPE_INT:    return (float) mIntegerValue;
        case TypedValues::Custom::TYPE_FLOAT:  return mFloatValue;
        case TypedValues::Custom::TYPE_BOOLEAN:return mBooleanValue ? 1 : 0;
        case TypedValues::Custom::TYPE_DIMENSION: return mFloatValue;
...
void CustomVariable::getValuesToInterpolate(std::vector<float>& ret) const {
    switch (mType) {
        case TypedValues::Custom::TYPE_INT:   ret[0] = (float) mIntegerValue; break;
        case TypedValues::Custom::TYPE_FLOAT: ret[0] = mFloatValue; break;
        case TypedValues::Custom::TYPE_BOOLEAN: ret[0] = mBooleanValue ? 1 : 0; break;
        case TypedValues::Custom::TYPE_DIMENSION: ret[0] = mFloatValue; break;
        case TypedValues::Custom::TYPE_COLOR: {
...
void CustomVariable::setValue(const std::vector<float>& value) {
    switch (mType) {
        case TypedValues::Custom::TYPE_REFERENCE:
        case TypedValues::Custom::TYPE_INT: mIntegerValue = (int) value[0]; break;
        case TypedValues::Custom::TYPE_FLOAT:
        case TypedValues::Custom::TYPE_DIMENSION: mFloatValue = value[0]; break;
        case TypedValues::Custom::TYPE_COLOR: {
        ...
        case TypedValues::Custom::TYPE_BOOLEAN: mBooleanValue = value[0] > 0.5; break;
        default: break;
    }
}
...
int CustomVariable::hsvToRgb(float hue, float saturation, float value) {
    ...
    switch (h) {
        case 0: return 0xFF000000 | (v << 16) + (t << 8) + p;
        case 1: return 0xFF000000 | (q << 16) + (v << 8) + p;
        case 2: return 0xFF000000 | (p << 16) + (v << 8) + t;
        case 3: return 0xFF000000 | (p << 16) + (q << 8) + v;
        case 4: return 0xFF000000 | (t << 16) + (p << 8) + v;
        case 5: return 0xFF000000 | (v << 16) + (p << 8) + q;
        default: return 0;
    }
}
...
bool CustomVariable::diff(const CustomVariable& other) const {
    ...
    switch (mType) {
        ...
        case TypedValues::Custom::TYPE_REFERENCE:
        case TypedValues::Custom::TYPE_COLOR: return mIntegerValue == other.mIntegerValue;
        case TypedValues::Custom::TYPE_FLOAT:
        case TypedValues::Custom::TYPE_DIMENSION: return mFloatValue == other.mFloatValue;
        case TypedValues::Custom::TYPE_STRING: return mIntegerValue == other.mIntegerValue;
        case TypedValues::Custom::TYPE_BOOLEAN: return mBooleanValue == other.mBooleanValue;
...
void CustomVariable::setInterpolatedValue(MotionWidget* view, const std::vector<float>& value) {
    switch (mType) {
        case TypedValues::Custom::TYPE_INT:
            view->setCustomAttribute(mName, mType, (int) value[0]); break;
        case TypedValues::Custom::TYPE_COLOR: {
            int r = clamp((int) (std::pow(value[0], 1.0 / 2.2) * 255.0f));
            int g = clamp((int) (std::pow(value[1], 1.0 / 2.2) * 255.0f));
            int b = clamp((int) (std::pow(value[2], 1.0 / 2.2) * 255.0f));
        ...
        case TypedValues::Custom::TYPE_BOOLEAN:
            view->setCustomAttribute(mName, mType, value[0] > 0.5f); break;
        case TypedValues::Custom::TYPE_DIMENSION:
        case TypedValues::Custom::TYPE_FLOAT:
            view->setCustomAttribute(mName, mType, value[0]); break;
        default: break;
    }
}
...
void CustomVariable::applyToWidget(MotionWidget* view) {
    switch (mType) {
        ...
        case TypedValues::Custom::TYPE_COLOR:
        case TypedValues::Custom::TYPE_REFERENCE:
            view->setCustomAttribute(mName, mType, mIntegerValue); break;
        case TypedValues::Custom::TYPE_STRING:
            view->setCustomAttribute(mName, mType, mStringValue); break;
        case TypedValues::Custom::TYPE_BOOLEAN:
            view->setCustomAttribute(mName, mType, mBooleanValue); break;
        case TypedValues::Custom::TYPE_DIMENSION:
        case TypedValues::Custom::TYPE_FLOAT:
            view->setCustomAttribute(mName, mType, mFloatValue); break;
        default: break;
    }
}
