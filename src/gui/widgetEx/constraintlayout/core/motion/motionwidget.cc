...
// --- geometry ---
int MotionWidget::getTop() const    {
    return mWidgetFrame->top;
}

int MotionWidget::getLeft() const   {
    return mWidgetFrame->left;
}

int MotionWidget::getBottom() const {
    return mWidgetFrame->bottom;
}

int MotionWidget::getRight() const  {
    return mWidgetFrame->right;
}

int MotionWidget::getX() const      {
    return mWidgetFrame->left;
}

int MotionWidget::getY() const      {
    return mWidgetFrame->top;
}

int MotionWidget::getWidth() const  {
    return mWidgetFrame->width();
}

int MotionWidget::getHeight() const {
    return mWidgetFrame->height();
}

int MotionWidget::getVisibility() const {
    return mWidgetFrame->visibility;
}

void MotionWidget::setVisibility(int visibility) {
    mWidgetFrame->visibility = visibility;
}
...
// --- transforms ---
float MotionWidget::getRotationX() const    {
    return mWidgetFrame->rotationX;
}

float MotionWidget::getRotationY() const    {
    return mWidgetFrame->rotationY;
}

float MotionWidget::getRotationZ() const    {
    return mWidgetFrame->rotationZ;
}

float MotionWidget::getTranslationX() const {
    return mWidgetFrame->translationX;
}

float MotionWidget::getTranslationY() const {
    return mWidgetFrame->translationY;
}

float MotionWidget::getTranslationZ() const {
    return mWidgetFrame->translationZ;
}

float MotionWidget::getScaleX() const       {
    return mWidgetFrame->scaleX;
}

float MotionWidget::getScaleY() const       {
    return mWidgetFrame->scaleY;
}

float MotionWidget::getPivotX() const       {
    return mWidgetFrame->pivotX;
}

float MotionWidget::getPivotY() const       {
    return mWidgetFrame->pivotY;
}

float MotionWidget::getAlpha() const        {
    return mWidgetFrame->alpha;
}

void MotionWidget::setRotationX(float v)    {
    mWidgetFrame->rotationX = v;
}

void MotionWidget::setRotationY(float v)    {
    mWidgetFrame->rotationY = v;
}

void MotionWidget::setRotationZ(float v)    {
    mWidgetFrame->rotationZ = v;
}

void MotionWidget::setTranslationX(float v) {
    mWidgetFrame->translationX = v;
}

void MotionWidget::setTranslationY(float v) {
    mWidgetFrame->translationY = v;
}

void MotionWidget::setTranslationZ(float v) {
    mWidgetFrame->translationZ = v;
}

void MotionWidget::setScaleX(float v)       {
    mWidgetFrame->scaleX = v;
}

void MotionWidget::setScaleY(float v)       {
    mWidgetFrame->scaleY = v;
}

void MotionWidget::setPivotX(float v)       {
    mWidgetFrame->pivotX = v;
}

void MotionWidget::setPivotY(float v)       {
    mWidgetFrame->pivotY = v;
}

void MotionWidget::setAlpha(float v)        {
    mWidgetFrame->alpha = v;
}
...
bool MotionWidget::setValue(int /*id*/, bool /*value*/) {
    return false;
}
