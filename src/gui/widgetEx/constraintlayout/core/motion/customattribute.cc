...
void CustomAttribute::setFloatValue(float value) { mFloatValue = value; }
void CustomAttribute::setColorValue(int value)   { mColorValue = value; }
void CustomAttribute::setIntValue(int value)     { mIntegerValue = value; }
void CustomAttribute::setStringValue(const std::string& value) { mStringValue = value; }
...
float CustomAttribute::getValueToInterpolate() const {
    switch (mType) {
        case AttributeType::INT_TYPE:     return (float) mIntegerValue;
        case AttributeType::FLOAT_TYPE:   return mFloatValue;
        case AttributeType::BOOLEAN_TYPE: return mBooleanValue ? 1 : 0;
        case AttributeType::DIMENSION_TYPE: return mFloatValue;
        case AttributeType::COLOR_TYPE:
        case AttributeType::COLOR_DRAWABLE_TYPE:
...
void CustomAttribute::getValuesToInterpolate(std::vector<float>& ret) const {
    switch (mType) {
        case AttributeType::INT_TYPE:     ret[0] = (float) mIntegerValue; break;
        case AttributeType::FLOAT_TYPE:   ret[0] = mFloatValue; break;
        case AttributeType::BOOLEAN_TYPE: ret[0] = mBooleanValue ? 1 : 0; break;
        case AttributeType::DIMENSION_TYPE: ret[0] = mFloatValue; break;
        case AttributeType::COLOR_TYPE:
        case AttributeType::COLOR_DRAWABLE_TYPE: {
...
void CustomAttribute::setValue(const std::vector<float>& value) {
    switch (mType) {
        ...
        case AttributeType::COLOR_DRAWABLE_TYPE:
            ...
            break;
        case AttributeType::BOOLEAN_TYPE:
            mBooleanValue = value[0] > 0.5; break;
        default: break;
    }
}
...
void CustomAttribute::setValue(int value) {
    switch (mType) {
        case AttributeType::REFERENCE_TYPE:
        case AttributeType::INT_TYPE: mIntegerValue = value; break;
        case AttributeType::COLOR_TYPE:
        case AttributeType::COLOR_DRAWABLE_TYPE: mColorValue = value; break;
        default: break;
    }
}
...
void CustomAttribute::setValue(float value) {
    switch (mType) {
        case AttributeType::FLOAT_TYPE:
        case AttributeType::DIMENSION_TYPE: mFloatValue = value; break;
        default: break;
    }
}
...
bool CustomAttribute::diff(const CustomAttribute& other) const {
    ...
    switch (mType) {
        case AttributeType::INT_TYPE:
        case AttributeType::REFERENCE_TYPE: return mIntegerValue == other.mIntegerValue;
        case AttributeType::FLOAT_TYPE:
        case AttributeType::DIMENSION_TYPE: return mFloatValue == other.mFloatValue;
        case AttributeType::COLOR_TYPE:
        case AttributeType::COLOR_DRAWABLE_TYPE: return mColorValue == other.mColorValue;
        case AttributeType::STRING_TYPE: return mIntegerValue == other.mIntegerValue;
        case AttributeType::BOOLEAN_TYPE: return mBooleanValue == other.mBooleanValue;
