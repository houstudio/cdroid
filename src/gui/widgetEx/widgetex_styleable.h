...
// Source: attrs.xml, attrs.xml, attrs.xml, attrs.xml, attrs.xml, attrs.xml, attrs.xml, attrs.xml, attrs.xml, attrs.xml  (fw-ids: framework_attrids.txt)
...
namespace internal { namespace R { namespace styleable {
    ...
    // WearableRecyclerView (3 attrs)
    extern const uint32_t WearableRecyclerView[];
    constexpr int WearableRecyclerView_bezelWidth = 0;
    constexpr int WearableRecyclerView_circularScrollingGestureEnabled = 1;
    constexpr int WearableRecyclerView_scrollDegreesPerScreen = 2;

    // CircularProgressLayout (4 attrs)
    extern const uint32_t CircularProgressLayout[];
    constexpr int CircularProgressLayout_backgroundColor = 0;
    constexpr int CircularProgressLayout_strokeWidth = 1;
    constexpr int CircularProgressLayout_colorSchemeColors = 2;
    constexpr int CircularProgressLayout_indeterminate = 3;

    // RoundedDrawable (4 attrs)
    extern const uint32_t RoundedDrawable[];
    constexpr int RoundedDrawable_src = 0;
    constexpr int RoundedDrawable_radius = 1;
    constexpr int RoundedDrawable_backgroundColor = 2;
    constexpr int RoundedDrawable_clipEnabled = 3;

    // BoxInsetLayoutLayout (2 attrs)
