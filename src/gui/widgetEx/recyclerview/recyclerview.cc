...
RecyclerView::RecyclerView(Context* context,const AttributeSet* pAttrs,int defStyleAttr)
   :ViewGroup(context, pAttrs, defStyleAttr){
    ...
    auto ta = context->obtainStyledAttributes(attrs, internal::R::styleable::RecyclerView, defStyleAttr);

    initRecyclerView();
    initAdapterManager();
    initChildrenHelper();
    initAutofill();
    mClipToPadding = ta&&ta->hasValue(internal::R::styleable::RecyclerView_clipToPadding) ? ta->getBoolean(internal::R::styleable::RecyclerView_clipToPadding, true) : attrs.getBoolean("clipToPadding", true);
    // If not explicitly specified this view is important for accessibility.
    if (getImportantForAccessibility() == View::IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
        setImportantForAccessibility(View::IMPORTANT_FOR_ACCESSIBILITY_YES);
    }
    ...
    std::string layoutManagerName = ta&&ta->hasValue(internal::R::styleable::RecyclerView_layoutManager) ? ta->getString(internal::R::styleable::RecyclerView_layoutManager) : attrs.getString("layoutManager");
    const int descendantFocusability = ta&&ta->hasValue(internal::R::styleable::RecyclerView_descendantFocusability) ? ta->getInt(internal::R::styleable::RecyclerView_descendantFocusability, -1) : attrs.getInt("descendantFocusability", -1);
    if (descendantFocusability == -1) {
        setDescendantFocusability(ViewGroup::FOCUS_AFTER_DESCENDANTS);
    }
    mEnableFastScroller = ta&&ta->hasValue(internal::R::styleable::RecyclerView_fastScrollEnabled) ? ta->getBoolean(internal::R::styleable::RecyclerView_fastScrollEnabled, false) : attrs.getBoolean("fastScrollEnabled", false);
    if (mEnableFastScroller) {
        StateListDrawable* verticalThumbDrawable = (StateListDrawable*) (ta&&ta->hasValue(internal::R::styleable::RecyclerView_fastScrollVerticalThumbDrawable) ? ta->getDrawable(internal::R::styleable::RecyclerView_fastScrollVerticalThumbDrawable) : attrs.getDrawable("fastScrollVerticalThumbDrawable"));
        Drawable* verticalTrackDrawable = ta&&ta->hasValue(internal::R::styleable::RecyclerView_fastScrollVerticalTrackDrawable) ? ta->getDrawable(internal::R::styleable::RecyclerView_fastScrollVerticalTrackDrawable) : attrs.getDrawable("fastScrollVerticalTrackDrawable");
        StateListDrawable* horizontalThumbDrawable = (StateListDrawable*) (ta&&ta->hasValue(internal::R::styleable::RecyclerView_fastScrollHorizontalThumbDrawable) ? ta->getDrawable(internal::R::styleable::RecyclerView_fastScrollHorizontalThumbDrawable) : attrs.getDrawable("fastScrollHorizontalThumbDrawable"));
        Drawable* horizontalTrackDrawable = ta&&ta->hasValue(internal::R::styleable::RecyclerView_fastScrollHorizontalTrackDrawable) ? ta->getDrawable(internal::R::styleable::RecyclerView_fastScrollHorizontalTrackDrawable) : attrs.getDrawable("fastScrollHorizontalTrackDrawable");
        initFastScroller(verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable,attrs);
    }
