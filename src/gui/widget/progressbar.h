...
public:
    ProgressBar(Context*ctx);
    ProgressBar(Context*ctx,const AttributeSet*attrs);
    ProgressBar(Context*ctx,const AttributeSet* attrs,int defStyleAttr);
    ...
    void setProgressTintList(const cdroid::RefPtr<ColorStateList>&tint);
    const cdroid::RefPtr<ColorStateList>getProgressTintList()const;
    void setProgressTintMode(int);
    int getProgressTintMode()const;
    void setProgressBackgroundTintList(const cdroid::RefPtr<ColorStateList>&tint);
    const cdroid::RefPtr<ColorStateList>getProgressBackgroundTintList()const;
    void setProgressBackgroundTintMode(int);
    int getProgressBackgroundTintMode()const;
    void setSecondaryProgressTintList(const cdroid::RefPtr<ColorStateList>&tintt);
    const cdroid::RefPtr<ColorStateList>getSecondaryProgressTintList()const;
