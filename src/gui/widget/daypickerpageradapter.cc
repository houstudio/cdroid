...
void DayPickerPagerAdapter::setCalendarTextColor(const cdroid::RefPtr<ColorStateList>& calendarTextColor) {
...
void DayPickerPagerAdapter::setDaySelectorColor(const cdroid::RefPtr<ColorStateList>& selectorColor) {
