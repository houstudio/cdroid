...
AnalogClock::AnalogClock(Context*ctx,const AttributeSet* pAttrs,int defStyleAttr)
  :View(ctx,pAttrs, defStyleAttr){
    ...
    auto ta = ctx->obtainStyledAttributes(attrs, internal::R::styleable::AnalogClock, defStyleAttr);
    

setDial (ta->getDrawable(internal::R::styleable::AnalogClock_dial));
setHourHand( ta->getDrawable(internal::R::styleable::AnalogClock_hand_hour));
setMinuteHand( ta->getDrawable(internal::R::styleable::AnalogClock_hand_minute));
setSecondHand( ta->getDrawable(internal::R::styleable::AnalogClock_hand_second));
...
void AnalogClock::setDialTintList(const cdroid::RefPtr<ColorStateList>& tint) {
...
const cdroid::RefPtr<ColorStateList> AnalogClock::getDialTintList()const {
...
void AnalogClock::setHourHandTintList(const cdroid::RefPtr<ColorStateList>& tint) {
...
const cdroid::RefPtr<ColorStateList> AnalogClock::getHourHandTintList()const{
...
void AnalogClock::setMinuteHandTintList(const cdroid::RefPtr<ColorStateList>& tint) {
...
const cdroid::RefPtr<ColorStateList> AnalogClock::getMinuteHandTintList()const{
