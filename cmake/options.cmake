...
if(LCMS2_FOUND AND ENABLE_LCMS)
    list(APPEND CDROID_DEPLIBS ${LCMS2_LIBRARIES})
else()
    set(ENABLE_LCMS OFF)
endif()
...
if(ENABLE_JPEG AND (TURBOJPEG_FOUND OR JPEG_FOUND))
    #message(FATAL_ERROR "----${ENABLE_JPEG}-${TURBOJPEG_FOUND} ${JPEG_FOUND}")
    if (TURBOJPEG_FOUND AND NOT JPEG_FOUND)
        set(ENABLE_TURBOJPEG ON)
    ...
    #message(FATAL_ERROR "${JPEG_LIBRARIES}--${TURBOJPEG_LIBRARIES}")
else()
    set(ENABLE_JPEG OFF)
