...
sudo apt install autoconf libtool build-essential cmake gdb pkg-config zip gettext libx11-dev libxcb1-dev libxcb-image0-dev bison python>=3.7 pip3-python python3-lxml meson
###  2.install vcpkg:
